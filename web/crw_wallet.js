...
* @returns {string}
*/
__exports.randomMnemonic = function() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.randomMnemonic(retptr);
...
class MnemonicWallet {
    ...
    free() {
        ...
        wasm.__wbg_mnemonicwallet_free(ptr);
    }
    /**
    ...
    */
    constructor(mnemonic, derivation_path) {
        ...
        var ptr1 = passStringToWasm0(derivation_path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len1 = WASM_VECTOR_LEN;
        var ret = wasm.mnemonicwallet_new(ptr0, len0, ptr1, len1);
        return MnemonicWallet.__wrap(ret);
    }
    /**
    * @param {string} new_derivation_path
    */
    setDerivationPath(new_derivation_path) {
        var ptr0 = passStringToWasm0(new_derivation_path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.mnemonicwallet_setDerivationPath(this.ptr, ptr0, len0);
    }
    /**
    * @param {string} hrp
    * @returns {string}
    */
    getBech32Address(hrp) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            var ptr0 = passStringToWasm0(hrp, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len0 = WASM_VECTOR_LEN;
            wasm.mnemonicwallet_getBech32Address(retptr, this.ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    * @returns {Uint8Array}
    */
    getPubKey(compressed) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.mnemonicwallet_getPubKey(retptr, this.ptr, isLikeNone(compressed) ? 0xFFFFFF : compressed ? 1 : 0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    sign(data) {
        try {
            ...
            var len0 = WASM_VECTOR_LEN;
            wasm.mnemonicwallet_sign(retptr, this.ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
...
__exports.MnemonicWallet = MnemonicWallet;
